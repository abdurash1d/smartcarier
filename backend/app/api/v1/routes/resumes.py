...
RESUME_I18N: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "generated_by": "Generated by CareerUZ",
        "page": "Page",
        "resume_id": "Resume ID",
        "status": "Status",
    ...
    "uz": {
        ...
        "generated_by": "CareerUZ tomonidan yaratildi",
        "page": "Sahifa",
    ...
    "ru": {
        ...
        "generated_by": "Сгенерировано CareerUZ",
        "page": "Страница",
        "resume_id": "ID резюме",
        "status": "Статус",
...
def _generate_pdf(resume: Resume) -> bytes:
    ...
    try:
        ...
        for regular_path, bold_path in (
            ...
            try:
                pdfmetrics.registerFont(TTFont("CareerUZ-Regular", regular_path))
                pdfmetrics.registerFont(TTFont("CareerUZ-Bold", bold_path))
                regular_font = "CareerUZ-Regular"
                bold_font = "CareerUZ-Bold"
                break
            except Exception:
                continue
